...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $data = [
    'secret' => "6LeYCBwaAAAAAGh3Ie4JWe-tB0dBLLdF3PeTuDpy",
...
# be able to control score result conditions, so I included that in this example.
  ...
  if ($res['success'] == true && $res['score'] >= 0.5) {
    ...
    # Recipient email
    $mail_to = "luke@verynicepictures.com, abanky92@gmail.com, ldavis383@gmail.com";

    # Sender form data
    $subject = "Very Nice Pictures Form Submission";
